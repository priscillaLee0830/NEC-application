...
class SwinLSKA(BaseModule):
    ...
    def __init__(self,
        ...
        self.LSKAttention0 = LSKAttention(96)
        self.LSKAttention1 = LSKAttention(192)
        self.LSKAttention2 = LSKAttention(384)
        self.LSKAttention3 = LSKAttention(768)
        # self.LSKAttention3 = LSKAttention(1536)
    ...
    def forward(self, x):
        ...
        out_lska = []
        # breakpoint()
        outs_lska0 = self.LSKAttention0(outs[0])
        outs_lska1 = self.LSKAttention1(outs[1])
        outs_lska2 = self.LSKAttention2(outs[2])
        outs_lska3 = self.LSKAttention3(outs[3])
        out_lska.append(outs_lska0)
        out_lska.append(outs_lska1)
        out_lska.append(outs_lska2)
        out_lska.append(outs_lska3)
        
        return out_lska

        # outs[0]  (B, 96, H/4, W/4)
        # outs[1]  (B, 192, H/8, W/8)
        # outs[2]  (B, 384, H/16, W/16)
        # outs[3]  (B, 768, H/32, W/32)
...
if __name__ == "__main__":
    ...
    self = SwinLSKA()
    level_output = self.forward(inputs)
